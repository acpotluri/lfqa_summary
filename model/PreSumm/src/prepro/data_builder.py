...
class BertData():
    ...
    def preprocess(self, src, tgt, sent_labels, use_bert_basic_tokenizer=False, is_test=False):
        ...
        # preprocessed the label here
        if self.args.task == 'role':
            # if this is role classification,
            # the label will be the list of roles
...
def format_to_bert(args):
    ...
    for corpus_type in datasets:
        a_lst = []
        print(">> reading files {}".format(args.raw_path))
